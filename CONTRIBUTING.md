...
1. Fork the repo, and clone down your forked version
...
```
git remote add upstream https://github.com/ivtpz/brancher.git
```
...
2. Be sure to `npm run test` and `npm run lint` before submitting a pull request.
